...
//var_dump($list);
?>
              <center><h1 id="bri"><strong>List des produits</strong></h1></center>
...
<table border="3" class="table">
    ...
    <th id="tt"><strong>prix</strong></th>
    <th id="tt"><strong>idm</strong></th>
    ...
    ?>
        <tr scope="row">
            ...
            <td><?php echo $p['prix']; ?></td>
             <td><?php echo $p['id_m']; ?></td>
           <td><a href="suppcat.php?id=<?php echo $p["id"];  ?>">
                <input type="button" value="supprimer  produit " class="btn btn-danger"></a></td>
            <td>  <a href="catEdit.php?id=<?php echo $p["id"];  ?>">
                <input type="submit" value="Modifier  produit"  class="btn btn-warning"></a></td>
