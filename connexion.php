...
if (!empty($_POST['login']) && !empty($_POST['mdp'])){
	...
	foreach($cn as $t){
		$vide=true;
	if ($t['login']==$_POST['login'] && $t['mdp']==$_POST['mdp'] && $_POST['admin']=='0'){
		
		session_start();
		$_SESSION['l']=$_POST['login'];
		$_SESSION['m']=$_POST['mdp'];
		$_SESSION['a']=$t['admin'];
		header("location:views_front\index.html");
		
		}
		if ($t['login']==$_POST['login'] && $t['mdp']==$_POST['mdp'] && $_POST['admin']=='1'){
		...
		header("location:views_back\index.html");
