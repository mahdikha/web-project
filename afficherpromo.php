        ...
        <div class="row mt">
          <div class="col-lg-6 col-md-6 col-sm-12">
             <?php
              ...
              $categor =new promotionc();
              $list=$categor->afficher();
//var_dump($list);
?>
              <center><h1 id="bri"><strong>List des promotions</strong></h1></center>
...
<table border="3" class="table">
    ...
    <th id="tt"><strong>idp</strong></th>
    <th id="tt"><strong>pourcentage</strong></th>
    <th id="tt"><strong>newprice</strong></th>
    ...
    <?php } }?>
                   ...
                   <h3><i class="fa fa-angle-right"></i> nombre totale des promos</h3>
          <div class="row mt">
          <div class="col-lg-12">
...
<div>
                  ...
                  <?php if(!empty($list)){ ?>
                      <a href="triercat1.php?Name=<?php echo $p["newprice"]; ?>">
