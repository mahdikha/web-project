...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>SAMAANI école</b></a>
      <!--logo end-->
    ...
    <section id="main-content">
      <section class="wrapper" >
        <h3><i class="fa fa-angle-right"></i> affichage des réclamations</h3>
        ...
        <div class="row mt">
            ...
            <div class="form-panel">
                 ...
                 <td>objet</td>
                  ...
                  <input type="submit" name="telecharger" value="télécharger">
                      ...
                      <h3><i class="fa fa-angle-right"></i> nombre totale des réclamations</h3>
          <div class="row mt">
          <div class="col-lg-12">
            <div class="form-panel">
             <?php
         ...
         <label style="color: black" >vous avez <h7 style="color:#00CED1"><?php echo $nbrec;?></h7> réclamations non traiter </label>
            </div>
          </div>
        </div>
                    ...
                    <form class="form-inline" method="POST" action="modifiereclamation.php">
                      <label style="color: black" for="id">Saisir l'id de la réclamation à modifier:</label><br>
                       ...
                       <input class="form-control" type="mail" name="mail" id="mail" placeholder="mail a modifier">
                       <input class="form-control" type="text" name="objet" id="objet" placeholder="objet a modifier"><br>
                       <textarea name="commentaire" id="co" placeholder="veuillez écrire ici la reclamation a modifier" ROWS=10 COLS=53  ></textarea><br>
                        </form>
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong>Samaani école</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
          ...
          -->
          Created with M.GURUS template by <a href="https://templatemag.com/">TemplateMag</a>
        </div>
