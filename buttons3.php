        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="ajout.php">ajouter une marque</a></li>
...
<form method="POST" name="platform" action="ajout3.php"  enctype="multipart/form-data">
<div>
    <label class="control-label">id de la marque</label>
    <div class="controls">
