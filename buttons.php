        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li class="active"><a href="ajout.php">ajouter marque</a></li>
              <li class="active"><a href="ajout.php">ajouter produit </a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
...
<form method="POST" name="platform" action="ajout.php"  enctype="multipart/form-data">
<div>
    <label class="control-label">Nom du produit</label>
    <div class="controls">
    <input class="controle" type="text" name="nom" required pattern="[a-zA-Z-\.]{3,12}" placeholder="saisir le nom du plat">
    </div>
    <p>
</div>
<div>
    ...
    <div class="controls">
    <input name="id" type="number" required pattern="[0-9]" x-moz-errormessage="Le prix doix etre des chiffres" placeholder="Prix">
    </div>
    <p>
</div>
<div>
...
<div>
    ...
    <div class="controls">
          <input name="idm" type="text" required>
...
<input type="submit" name="ajouter" value="Ajouter" class="btn btn-primary">
 <input type="reset" value="Reset" style="background-clor:#0c2646;border-color:#0c2646; color:white;">
  ...
  <script src="lib/common-scripts.js"></script>
                    ...
                    <form class="form-inline" method="POST" action="pdf2.php" >
                      <fieldset >

                      <div class="form-group">
                        
                        <label style="color: black" for="id">télécharger les produits.pdf:</label>
