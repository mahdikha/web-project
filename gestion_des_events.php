    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <h5 class="centered"> Iheb Mbarki</h5>
          <li class="mt">
            <a href="index.html">
      ...
      <section class="wrapper">
        <div class="row mt">
          <div class="col-lg-6 col-md-6 col-sm-12">
            ...
            <h3>Ajouter une event </h3>
<form method="POST" name="platform" action="ajoutevent.php"  enctype="multipart/form-data">
<div>
    <label class="control-label">Nom de l'event</label>
    <div class="controls">
    <input class="controle" type="text" name="nom" required pattern="[a-zA-Z-\.]{3,12}" placeholder="saisir le nom du l event">
    </div>
    <p>
</div>
<div>
...
<input type="submit" name="ajouter" value="Ajouter" class="btn btn-primary">
 <input type="reset" value="Reset" style="background-clor:#0c2646;border-color:#0c2646; color:white;">
  ...
  <script src="lib/common-scripts.js"></script>
                    ...
                    <form class="form-inline" method="POST" action="pdf3.php" >
                      <fieldset >

                      <div class="form-group">
                        
                        <label style="color: black" for="id">télécharger les events.pdf:</label>
